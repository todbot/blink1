...
void MainWindow::removeInput(QString key){
    inputs.remove(key);
    emit inputsUpdate();
}
...
void MainWindow::remove_email(QString name){
...
void MainWindow::remove_hardwareMonitor(QString name){
